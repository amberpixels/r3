...
func TestPgxRepository(t *testing.T) {
	...
	cityRepo := r3pgx.NewPgxCRUD[City, int64](db)
	locRepo := r3pgx.NewPgxCRUD[Location, int64](db)
	eventRepo := r3pgx.NewPgxCRUD[Event, int64](db)
	artistRepo := r3pgx.NewPgxCRUD[Artist, int64](db)
