...
//
// Filters are validated against the schema and reuse the same filter→SQL
// translation as List (including relationship "has" filter lowering). Soft-delete
// exclusion follows GORM's default model scoping.
