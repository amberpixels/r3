...
VALUES
    (DATE_ADD(NOW(), INTERVAL 1 HOUR), 101, 1, true),
    (DATE_ADD(NOW(), INTERVAL 2 HOUR), 102, 2, true),
    (DATE_ADD(NOW(), INTERVAL 3 HOUR), 103, 3, true),
    (DATE_ADD(NOW(), INTERVAL 4 HOUR), 104, 4, true),
    (DATE_ADD(NOW(), INTERVAL 5 HOUR), 105, 5, true),
    (DATE_ADD(NOW(), INTERVAL 6 HOUR), 106, 1, true),
    (DATE_ADD(NOW(), INTERVAL 7 HOUR), 107, 2, true),
    (DATE_ADD(NOW(), INTERVAL 8 HOUR), 108, 3, true);
