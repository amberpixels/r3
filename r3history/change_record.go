// Package r3history provides activity log / change tracking for r3 CRUD repositories.
//
...
// with their own storage — see SnapshotRule and SnapshotStore.
...
// Used with Store.ForTree() to retrieve changes for a record and all its descendants.
//
