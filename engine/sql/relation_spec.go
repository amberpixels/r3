...
// table and column names) into a [RelationMeta]. The target Go type is unknown -
...
// spec wins). The input meta is never mutated (shared and cached); a nil/empty
// specs returns meta unchanged.
