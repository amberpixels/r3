// Package mongobase provides a shared base driver for all r3 CRUD implementations
...
//
// This is the MongoDB equivalent of the sqlbase package.
//
...
// It is the MongoDB equivalent of sqlbase.StructMeta.
